...
##############################################################################
#         SEE README.TXT FILE THAT CAME WITH THIS SCRIPT FOR HELP            #
#   OR: Consult the Matt's Script Archive Frequently Asked Questions if you  #
...
$guestbookurl = "http://skywalker.pa.msu.edu/peter/guestbook.html";
$guestbookreal = "/scratch/httpd/html/peter/guestbook.html";
$guestlog = "/scratch/httpd/html/peter/guestbook/guestlog.html";
$cgiurl = "http://skywalker.pa.msu.edu/cgi-bin/guestbook.pl";
